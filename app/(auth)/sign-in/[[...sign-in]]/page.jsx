    ...
    <main className="w-full flex">
      ...
      <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(152.92deg, rgba(99,102,241,0.3) 4.54%, rgba(168,85,247,0.35) 34.2%, rgba(236,72,153,0.2) 77.55%)",
            filter: "blur(120px)",
          }}
        />
      </div>
          ...
          <SignIn
            appearance={{
              elements: {
                ...
                formButtonPrimary:
                  "bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg py-2 mt-4",
                socialButtonsBlockButton:
                  "border border-gray-300 rounded-lg py-2 text-gray-700 hover:bg-gray-50",
                formFieldInput:
                  "bg-gray-50 border border-gray-300 text-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-500",
                headerTitle: "hidden",
